...
\par Testing for the method pay is most important. I should design two orders which will partly choose two promotion strategies. According to the order, I can guess what the discount may be. So the next step is to check it. And the two test methods are \emph{testPayWithFullReduction} and \emph{testPayWithCombination}.
\par Well, testings for some important fucntions are over, but there may be some unexpected exceptions. I take in some exceptions
